$(function () {
  ...
  var user_id_ok, user_pw_ok, user_pw2_ok, user_name_ok, user_phone_ok, user_birth_ok, user_id_check_ok; // 각 항목 벨리데이션 확인 값
  ...
  // 회원가입 버튼 활성화 비활성화 함수
   $.fn.signup_ok_check = function () {
     if (user_id_ok == 0 && user_pw_ok == 0 && user_pw2_ok == 0 && user_name_ok == 0 && user_phone_ok == 0 && user_birth_ok == 0){
